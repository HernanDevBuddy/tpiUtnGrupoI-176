...
(function(r,t,l){var u={required:"El campo %s es obligatorio.",matches:"El campo %s no coincide con el campo %s.","default":"El campo %s todavía está configurado como predeterminado, cámbielo.",valid_email:"El campo %s debe contener una dirección de correo electrónico válida.",valid_emails:"El campo %s debe contener todas las direcciones de correo electrónico válidas.",min_length:"El campo %s debe tener al menos %s caracteres de longitud.",max_length:"El campo %s no debe exceder los %s caracteres de longitud.",exact_length:"El campo %s debe tener exactamente %s caracteres de longitud.",
...
is_natural:"El campo %s debe contener solo números positivos.",is_natural_no_zero:"El campo %s debe contener un número mayor que cero.",valid_ip:"El campo %s debe contener una IP válida.",valid_base64:"El campo %s debe contener una cadena base64.",valid_credit_card:"El campo %s debe contener un número de tarjeta de crédito válido.",is_file_type:"El campo %s debe contener solo archivos %s.",valid_url:"El %s debe contener una URL válida.",greater_than_date:"El campo %s debe contener una fecha más reciente que %s.",less_than_date:"El campo %s debe contener una fecha anterior a %s.",
greater_than_or_equal_date:"El campo %s debe contener una fecha que sea al menos tan reciente como %s.",less_than_or_equal_date:"El campo %s debe contener una fecha que sea %s o anterior."},v=function(a){},w=/^(.+?)\[(.+)\]$/,g=/^[0-9]+$/,x=/^\-?[0-9]+$/,m=/^\-?[0-9]*\.?[0-9]+$/,q=/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,y=/^[a-z]+$/i,z=/^[a-z0-9]+$/i,A=/^[a-z0-9_\-]+$/i,B=/^[0-9]+$/i,C=/^[1-9][0-9]*$/i,D=/^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i,
